...
namespace Sughd.Auto.Infrastructure.Migrations
{
    ...
    [Migration("20240404081341_ConfiguretedCarModel")]
    partial class ConfiguretedCarModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sughd.Auto.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Sughd.Auto.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sughd.Auto.Domain.Models.Car", b =>
                {
                    ...
                    b.HasOne("Sughd.Auto.Domain.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
